  ...
  return (
    <>
      <Breadcrumb
        homeUrl={"/"}
        currentUrl={""}
        homeContent={"Trang chủ"}
        currentContent={"Book Journey Diary"}
        bgColor={"#f5f5f5"}
        color={"black"}
      />
      <div className="container-fluid books position-relative">
        ...
        <div className="row">
          <div className={`mx-auto ${responsive.mobile ? "col-12" : "col-9"}`}>
            <div
              className={`min-vh-100 mw-100 ${
                responsive.mobile ? "p-0 pt-4 pb-4" : "p-4"
              } ${
                responsive.mobile
                  ? "justify-content-center"
                  : "justify-content-start"
              } d-flex flex-column align-items-center border-start border-end border-black`}
            >
              {loading ? (
                ...
                <motion.div
                  ...
                  className={`position-relative books-content ${book?.color} ${
                    responsive.mobile ? "w-100" : "w-50"
                  }`}
                >
                  ...
                  <div>
                    <p className="italic text-sm mb-4">{book?.subject}</p>
                  </div>
                  <div
                    className={`mx-auto text-center ${
                      responsive.mobile ? "col-12" : "col-7"
                    }`}
                  >
                    <img
                      src={book?.image}
                      alt={book?.title}
                      className="rounded-5 object-fit-cover mb-4 accordion"
                    />
                  ...
                  <div className="d-flex justify-content-between align-items-center mt-4">
                    <div className="fs-5 d-flex align-items-center justify-content-around gap-2">
                      ...
                      {book?.progress < 100 && book?.progress > 0
                        ? "Đang đọc"
                        : book?.progress === 0
                        ? "Chưa đọc"
                        : "Đã đọc"}
                      {!responsive.mobile ? (
                        <Flex gap="small" vertical style={{ width: 180 }}>
                          <Progress
                            percent={
                              book?.progress === 0 ? 100 : book?.progress
                            }
                            status={
                              book?.progress < 100 && book?.progress > 0
                                ? "active"
                    ...
                    <div className="d-flex gap-2">
                      <button
                        onClick={() => {
                          setCurrent(
                            (current - 1 + books?.length) % books?.length
                          );
                        }}
                      ...
                      <button
                        onClick={() =>
                          setCurrent((current + 1) % books?.length)
                        }
                        className="btn btn-outline-dark"
                      >
                        {" "}
